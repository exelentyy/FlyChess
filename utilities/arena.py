...
"""
flychess arena tournament script.
...
###############################################################################
from flychess.System import Log
...
from flychess.Savers.pgn import save
...
def findMatch():
    ...
    #       "flychess" in discoverer.getName(engines[i]).lower() or
    #       "flychess" in discoverer.getName(engines[j]).lower()]
    if not pos:
        return None, None
