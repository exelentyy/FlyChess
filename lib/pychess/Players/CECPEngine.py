...
from flychess.Utils import wait_signal
...
from flychess.Utils.Move import toSAN, toAN, parseAny
...
from flychess.Utils.logic import validate, getMoveKillingKing
from flychess.Utils.lutils.ldata import MATE_VALUE
from flychess.Utils.lutils.lmove import ParsingError
from flychess.Variants import variants
from flychess.Players.Player import PlayerIsDead, TurnInterrupt, InvalidMove
...
class CECPEngine(ProtocolEngine):
    ...
    def __onReadyForMoves(self, self_):
        if self.mode in (ANALYZING, INVERSE_ANALYZING):
            ...
            # http://code.google.com/p/flychess/issues/detail?id=515
