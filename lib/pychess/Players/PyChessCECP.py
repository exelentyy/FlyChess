...
from flychess.System import conf, fident
from flychess.Utils.book import getOpenings
...
from flychess.Utils.lutils.Benchmark import benchmark
from flychess.Utils.lutils.perft import perft
from flychess.Utils.lutils.LBoard import LBoard
from flychess.Utils.lutils.ldata import MAXPLY
from flychess.Utils.lutils import lsearch, leval
from flychess.Utils.lutils.lmove import parseSAN, parseAny, toSAN, ParsingError
from flychess.Utils.lutils.lmovegen import genAllMoves, genCaptures, genCheckEvasions
from flychess.Utils.lutils.validator import validateMove
from flychess.System.Log import log
from flychess.Variants.horde import HORDESTART
from flychess.Variants.placement import PLACEMENTSTART
from flychess.Variants.threecheck import THREECHECKSTART
from flychess.Variants.asean import (
    ASEANSTART,
    MAKRUKSTART,
    KAMBODIANSTART,
    SITTUYINSTART,
)
from flychess.Variants.seirawan import SCHESSSTART
from flychess.Variants.lightbrigade import LIGHTBRIGADESTART
...
class flychessCECP(flychess):
    def __init__(self):
        ...
        self.features = {
            ...
            "reuse": 1,
            "analyze": 1,
            "myname": "flychess %s" % flychess.VERSION,
            ...
            try:
                ...
                # Unimplemented: pause, resume
                    ...
                    if len(lines) >= 3 and lines[1] == "gaviota":
                        ...
                        from flychess.Utils.lutils.lsearch import enableEGTB
    ...
    def __go(self):
        ...
        self.thread = Thread(
            target=flychess._flychess__go,
            name=fident(flychess._flychess__go),
            args=(self, ondone),
        )
    ...
    def __analyze(self):
        self.thread = Thread(
            target=flychess._flychess__analyze,
            name=fident(flychess._flychess__analyze),
            args=(self,),
        )
        self.thread.daemon = True
        self.thread.start()
