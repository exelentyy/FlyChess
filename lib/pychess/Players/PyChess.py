...
try:
    from flychess.Utils.book import getOpenings  # nopep8
    ...
    from flychess.Utils.lutils import lsearch  # nopep8
    from flychess.Utils.lutils.ldata import MAXPLY  # nopep8
    from flychess.Utils.lutils.lsearch import alphaBeta  # nopep8
    from flychess.Utils.lutils.lmove import listToSan, toSAN  # nopep8
    from flychess.System.Log import log  # nopep8
except ImportError:
    print("ERROR: failed to start flychess.py engine")
    sys.exit(1)
