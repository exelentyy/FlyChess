...
class Sidepanel:
    ...
    def onMessageRecieved(self, player, text):
        sender = (
            "flychessbot" if player.gamemodel.offline_lecture else repr(self.opplayer)
        )
