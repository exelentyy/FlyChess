...
from flychess.Utils.eco import get_eco
from flychess.Utils.IconLoader import get_pixbuf
from flychess.Utils.logic import legalMoveCount
from flychess.Utils.Move import Move, toSAN, toFAN, listToMoves
...
__about__ = _("Official flychess panel.")
...
class EndgameAdvisor(Advisor):
    def __init__(self, store, tv, boardcontrol):
        ...
        # deferred import to not slow down flychess starting up
        from flychess.Utils.EndgameTable import EndgameTable
