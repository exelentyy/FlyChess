...
from flychess.Savers.ChessFile import LoadingError
from flychess.Savers import epd, fen, pgn, olv, png, database, html, txt
from flychess.System import conf
from flychess.System.Log import log
from flychess.System.protoopen import isWriteable
from flychess.System.uistuff import GladeWidgets
from flychess.System.prefix import addUserConfigPrefix
from flychess.Savers.pgn import parseDateTag
...
from flychess.Utils.Offer import Offer
from flychess.widgets import gamewidget, mainwindow, new_notebook
from flychess.widgets.gamenanny import game_nanny
...
from flychess.widgets.pydock.__init__ import CENTER, EAST, SOUTH
from flychess.ic.ICGameModel import ICGameModel
...
class Games(GObject.GObject, Perspective):
    ...
    async def generalStart(self, gamemodel, player0tup, player1tup, loaddata=None):
        ...
        for i, playertup in enumerate((player0tup, player1tup)):
            ...
            if type != LOCAL:
                ...
                # Until flychess has a proper profiles system, as discussed on the
    ...
    def saveGamePGN(self, game):
        ...
        try:
            ...
            # save to .scout
            from flychess.Savers.pgn import scoutfish_path
            ...
            if index == 0:
                if ending not in enddir:
                    ...
                    d.format_secondary_text(
                        _(
                            "Was unable to save '%(uri)s' as flychess doesn't know the format '%(ending)s'."
                        )
    ...
    Please ensure that you have given the right path and try again.")
            ...
            try:
                ...
                d.set_markup(
                    _("<big><b>flychess was not able to save the game</b></big>")
                )
                d.format_secondary_text(
