...
from flychess.ic.FICSObjects import FICSPlayer, get_rating_range_display_text
...
from flychess.widgets.ChainVBox import ChainVBox
...
class SeekChallengeSection:
    ...
    def __showSeekEditor(self, seeknumber, challengemode=False):
        ...
        # ugly hack to fix https://github.com/flychess/flychess/issues/1024
