...
from flychess.ic.FICSObjects import FICSPlayer, get_player_tooltip_text
from flychess.ic import TYPE_BLITZ, TYPE_LIGHTNING, TYPE_STANDARD, IC_STATUS_PLAYING
