...
class Sidepanel:
    def load(self, widgets, connection, lounge):
        ...
        # deferred imports to not slow down flychess starting up
        from flychess.widgets.ViewsPanel import ViewsPanel
        from flychess.widgets.InfoPanel import InfoPanel
        from flychess.widgets.ChannelsPanel import ChannelsPanel
    ...
    def onConversationAdded(self, panel, grp_id, text, grp_type):
        ...
        from flychess.widgets.ChatView import ChatView
