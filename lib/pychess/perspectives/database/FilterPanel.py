...
from flychess.Utils.const import chr2Sign, WHITE, BLACK, NORMALCHESS
from flychess.Utils.Piece import Piece
...
from flychess.widgets.gameinfoDialog import on_pick_date
from flychess.widgets.PieceWidget import PieceWidget
from flychess.widgets import mainwindow
from flychess.Variants import name2variant
...
class FilterPanel(Gtk.TreeView):
    def __init__(self, persp):
        ...
        self.persp = persp
        self.filtered = False
        self.widgets = uistuff.GladeWidgets("flychess.glade")
