...
from flychess.Utils.lutils.attack import isAttacked
from flychess.Utils.lutils.LBoard import LBoard
from flychess.Utils.lutils.lmove import FILE, RANK
...
from flychess.Savers import fen as fen_loader
...
class Sidepanel:
    ...
    def row_activated(self, widget, path, col):
        if path is None:
            ...
            from flychess.widgets.TaskerManager import learn_tasker
