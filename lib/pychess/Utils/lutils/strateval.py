...
from flychess.Utils.lutils.attack import staticExchangeEvaluate, getAttacks, defends
from flychess.Utils.lutils.lmove import toSAN, TCORD, FCORD, FLAG, PROMOTE_PIECE
...
from flychess.Utils.lutils.lmovegen import genCaptures, genAllMoves, newMove
from flychess.Utils.lutils.validator import validateMove
from flychess.Utils.repr import reprColor, reprPiece
from . import leval
...
def defencive_moves_safety(model, ply, phase):
    ...
    # flychess points tropism to queen for phase <= 3. Thus we set a high phase
