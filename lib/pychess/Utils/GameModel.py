...
from flychess.Players.Player import (
    PlayerIsDead,
    PassInterrupt,
    TurnInterrupt,
    InvalidMove,
...
from flychess.System.protoopen import protoopen, protosave
...
from flychess.Utils.DecisionSupportAlgorithm import DecisionSupportAlgorithm
from flychess.Savers import html, txt
...
class GameModel(GObject.GObject):
    ...
    async def start_analyzer(self, analyzer_type, force_engine=None):
        ...
        if os.environ.get("flychess_UNITTEST") or (
        ...
        from flychess.Players.engineNest import init_engine
