...
from flychess.System.prefix import getEngineDataPrefix, addDataPrefix
from flychess.Utils.IconLoader import get_pixbuf
from flychess.Players.engineNest import discoverer, is_uci, is_cecp, ENGINE_DEFAULT_LEVEL
from flychess.Players.engineList import VM_LIST, listEnginesFromPath
from flychess.Utils.isoCountries import ISO3166_LIST
    ...
    def __init__(self, widgets):
        ...
        def selection_changed(treeselection):
            ...
            if tv_iter:
                ...
                if "flychess.py" in engine["command"]:
                    self.widgets["remove_engine_button"].set_sensitive(False)
                else:
