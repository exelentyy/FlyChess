...
from flychess.Utils.LearnModel import LearnModel
from flychess.System import conf
from flychess.System.Log import log
from flychess.widgets import preferencesDialog
from flychess.widgets.InfoBar import InfoBarMessage, InfoBarMessageButton
from flychess.widgets import InfoBar, mainwindow
from flychess.widgets.gamewidget import getWidgets
...
class GameNanny:
        ...
        if isinstance(gamemodel, ICGameModel):
            ...
            def callback(infobar, response, message, gamemodel=gamemodel):
                if response == 1:
                    ...
                    from flychess.widgets.newGameDialog import createRematch
    ...
    def engineDead(self, engine, gmwidg):
        ...
        dialog.format_secondary_text(
            _(
                "flychess has lost connection to the engine, probably because it has died.\n\n \
