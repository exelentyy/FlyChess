"""This module handles the tabbed layout in flychess"""
...
from flychess.Utils.Move import listToMoves
from flychess.Utils.lutils import lmove
from flychess.Utils.lutils.lmove import ParsingError
from flychess.Utils.logic import playerHasMatingMaterial, isClaimableDraw
from flychess.ic import get_infobarmessage_content, get_infobarmessage_content2
from flychess.ic.FICSObjects import get_player_tooltip_text
from flychess.ic.ICGameModel import ICGameModel
from flychess.widgets import createImage, createAlignment, gtk_close
from flychess.widgets.InfoBar import (
    InfoBarNotebook,
    InfoBarMessage,
...
def setWidgets(w):
    global widgets
    widgets = w
    flychess.widgets.main_window = widgets["main_window"]
...
class GameWidget(GObject.GObject):
    ...
    def infront(self):
        ...
        getWidgets()["main_window"].set_title(
            self.display_text + (" - " if self.display_text != "" else "") + "flychess"
        )
