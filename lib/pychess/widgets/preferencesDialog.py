...
from flychess.System import conf, gstreamer, uistuff
from flychess.Players.engineNest import discoverer
from flychess.Utils import book
...
from flychess.gfx import Pieces
from flychess.widgets import mainwindow
from flychess.widgets.Background import newTheme
...
def anal_combo_set_value(combobox, value, show_arrow_check, analyzer_type):
    ...
    from flychess.widgets.gamewidget import widgets
...
class PanelTab:
    ...
    def __set_panel_active(self, panel, active):
        ...
        from flychess.widgets.pydock import EAST
    ...
    def showit(self):
        from flychess.widgets.gamewidget import showDesignGW

        showDesignGW()

    def hideit(self):
        from flychess.widgets.gamewidget import hideDesignGW
