...
from flychess.Savers.pgn import comment_arrows_re, comment_circles_re
...
from flychess.widgets.preferencesDialog import board_items
...
class BoardView(Gtk.DrawingArea):
    ...
    def runAnimation(self, redraw_misc=False):
        """
        The animationsystem in flychess is very loosely inspired by the one of
    ...
    def expose(self, widget, ctx):
        ...
        if False:
            ...
            stats = Stats("/tmp/flychessprofile")
