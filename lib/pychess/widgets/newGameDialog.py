...
from flychess.Utils.IconLoader import load_icon, get_pixbuf
from flychess.Utils.GameModel import GameModel
from flychess.Utils.SetupModel import SetupModel, SetupPlayer
...
from flychess.Utils.repr import localReprSign
from flychess.Utils.lutils.ldata import FILE
...
from flychess.System.prefix import getDataPrefix, isInstalled, addDataPrefix
from flychess.Players.engineNest import discoverer
from flychess.Players.Human import Human
from flychess.widgets import ImageMenu, mainwindow
from flychess.widgets.prompttext import getUserTextDialog
from flychess.widgets.BoardControl import BoardControl
from flychess.Savers import fen, pgn
from flychess.Savers.ChessFile import LoadingError
from flychess.Variants import variants
from flychess.Variants.normal import NormalBoard
from flychess.perspectives import perspective_manager
from flychess.perspectives.games import enddir
from flychess.Utils.eco import find_opening_fen
...
class EnterNotationExtension(_GameInitializationMode):
    ...
    def _init(cls):
        ...
        flags = []
        if isInstalled():
            path = gettext.find("flychess")
        else:
            path = gettext.find("flychess", localedir=addDataPrefix("lang"))
        if path:
