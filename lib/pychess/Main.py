...
from flychess.System import conf, uistuff, prefix
from flychess.Utils.const import HINT, NAME, SPY, NORMALCHESS
from flychess.Utils.checkversion import isgit, checkversion
from flychess.Utils.IconLoader import get_pixbuf
from flychess.widgets import enginesDialog, newGameDialog
from flychess.widgets.Background import hexcol
from flychess.widgets.tipOfTheDay import TipOfTheDay
from flychess.widgets.discovererDialog import DiscovererDialog
from flychess.widgets.ExternalsDialog import ExternalsDialog
from flychess.widgets import gamewidget
from flychess.widgets.analyzegameDialog import AnalyzeGameDialog
from flychess.widgets import preferencesDialog, gameinfoDialog, playerinfoDialog
from flychess.widgets.TaskerManager import internet_game_tasker
from flychess.widgets.RecentChooser import recent_menu, recent_manager
from flychess.widgets.prompttext import getUserTextDialog
from flychess.Players.engineNest import discoverer
from flychess.Savers import chesspastebin
from flychess.Savers.pgn import PGNFile
from flychess.Savers.remotegame import get_internet_game
from flychess.System.protoopen import splitUri
from flychess.widgets import mainwindow
from flychess.ic import ICLogon
from flychess.perspectives import perspective_manager
from flychess.perspectives.welcome import Welcome
from flychess.perspectives.games import Games, get_open_dialog
from flychess.perspectives.learn import Learn
from flychess.perspectives.fics import FICS
from flychess.perspectives.database import Database
from flychess import VERSION, VERSION_NAME
...
class GladeHandlers:
    ...
    def on_window_key_press(self, window, event):
        ...
        if Gdk.keyval_name(event.keyval) == "F12":
            from flychess.System.debug import print_obj_referrers, print_muppy_sumary
    ...
    def on_log_viewer1_activate(self, widget):
        from flychess.widgets import LogDialog
    ...
    def translate_this_application_activate(self, widget):
        webbrowser.open("https://www.transifex.com/projects/p/flychess/")

    def report_issue_activate(self, widget):
        webbrowser.open("https://github.com/flychess/flychess/issues")


class flychess(Gtk.Application):
    def __init__(
        self,
        log_viewer,
        purge_recent,
        ...
        Gtk.Application.__init__(
            self, application_id="org.flychess", flags=Gio.ApplicationFlags.NON_UNIQUE
        )
    ...
    def do_startup(self):
        ...
        if self.purge_recent:
            ...
            for item in items:
                uri = item.get_uri()
                if item.get_application_info("flychess"):
        ...
        log.info(f"flychess {VERSION_NAME} {VERSION} git {self.git_rev}")
    ...
    def do_activate(self):
        ...
        # Try to set conf analyzer engine on very first start of flychess
    ...
    def initGlade(self, log_viewer):
        ...
        self.widgets = widgets = uistuff.GladeWidgets("flychess.glade")
        ...
        widgets["main_window"].set_title("%s - flychess" % _("Welcome"))
