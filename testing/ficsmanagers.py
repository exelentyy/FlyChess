...
from flychess.ic.FICSObjects import (
    FICSPlayer,
    FICSGames,
    FICSSeeks,
    FICSChallenges,
...
from flychess.ic import BLOCK_START, BLOCK_SEPARATOR, BLOCK_END
from flychess.ic.FICSConnection import Connection
from flychess.ic.VerboseTelnet import PredictionsTelnet, TelnetLine, BL
from flychess.ic.managers.AdjournManager import AdjournManager
from flychess.ic.managers.SeekManager import SeekManager
from flychess.ic.managers.BoardManager import BoardManager
from flychess.ic.managers.OfferManager import OfferManager
from flychess.ic.managers.HelperManager import HelperManager
from flychess.ic.managers.ErrorManager import ErrorManager
from flychess.ic.managers.FingerManager import FingerManager
from flychess.ic.managers.NewsManager import NewsManager
from flychess.ic.managers.ChatManager import ChatManager
from flychess.ic.managers.ConsoleManager import ConsoleManager
...
class AdjournManagerTests(EmittingTestCase):
    ...
    async def test2(self):
        ...
        lines = [
            ...
            " 2: W flychess       Y [psu  2  12] 39-39 W3   C20 Sun Jan 11, 17:40 ??? 2009",
            "fics% ",
        ]
...
class ConsoleManagerTests(EmittingTestCase):
    ...
    async def test1(self):
        ...
        lines = [
            ...
            "2: If you're using Linux check out flychess: http://www.flychess.org",
            BLOCK_END,
        ]
