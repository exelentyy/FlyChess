...
from flychess.Utils.const import FEN_START, NORMALCHESS
...
from flychess.widgets import enginesDialog
from flychess.widgets import newGameDialog
from flychess.widgets.newGameDialog import COPY, CLEAR, PASTE, INITIAL
...
class DialogTests(unittest.IsolatedAsyncioTestCase):
    ...
    async def test0(self):
        ...
        self.assertTrue("flychess.py" in engines)
