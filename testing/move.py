...
from flychess.Utils.const import GIVEAWAYCHESS, WILDCASTLECHESS, G1, G2, H2
from flychess.Utils.Move import Move
from flychess.Utils.lutils.LBoard import LBoard
from flychess.Utils.lutils.lmove import (
    parseAN,
    parseSAN,
    parseFAN,
    toFAN,
...
class MoveTestCase(unittest.TestCase):
    ...
    def test_paresSAN2(self):
        ...
        # If promotion piece is missing flychess assumes queen promotion from 0.99.2
